...
public:
    ...
    UNREALSHARPEDITOR_API void AddNewProject(const FString& ModuleName, const FString& ProjectParentFolder, const FString& ProjectRoot, TMap<FString, FString> Arguments = {}, bool bOpenProject = true, bool bSharedProject = false);
